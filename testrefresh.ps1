#Copy database environment: Test
# This script will clone the production environment down to the test environment: 
# It will clone the master and then the slave
# Usage testrefresh.ps1
#
...
$vcpass = ")LOA8C^ruZJ)"
$LogFile = "C:\Users\admin_llacroix\testrefresh.log"
...
# New vms:
$targetmaster = "tsmt-dbv03"
$targetslave = "tsmt-dbv04"
...
$appserver1 = "tsmt-apv01"
$appserver2 = "tsmt-apv02"
$appserver3 = ""
$NetworkName = "test-rdb-db"
$IPADDRmaster = "10.2.120.17"
$IPADDRslave = "10.2.120.18"
$GATEWAY = "10.2.120.1"
$environment = "test"
...
Start-Sleep -s 3 Send-MailMessage -To "fitsum.tesfagiorgis@reeher.reeher.com"  -From "IT <itnotifications@reeher.com>" -Subject "DB refresh is happening in $environment in 5 minutes..." -SmtpServer "reeher.mail.protection.outlook.com"
...
$Password = "HQnRqLX3hK"
$database = "reeher_dash_dbo"
$querymaster = "use reeher_dash_dbo; UPDATE reeher_dash_dbo.client SET idp_sso_target_url='https://app.onelogin.com/trust/saml2/http-post/sso/430394' WHERE client_id=3; UPDATE reeher_dash_dbo.client SET idp_sso_target_url='https://app.onelogin.com/trust/saml2/http-post/sso/430384' WHERE client_id=18;"
$ConnectionString = "Server=$targetmaster;uid=$UserName;pwd=$Password;Database=$database;Integrated Security=False;"
$MySQLConnection = New-Object -TypeName MySql.Data.MySqlClient.MySqlConnection
$MySQLConnection.ConnectionString = $ConnectionString
$MySQLConnection.Open()
...
#Notification for teams:
Send-MailMessage -To "fitsum.tesfagiorgis@reeher.com"   -From "IT <itnotifications@reeher.com>" -Subject "DB refresh in $environment is complete" -SmtpServer "reeher.mail.protection.outlook.com"
